\message{ !name(p1_2.tex)}\documentclass[../main.tex]{subfiles}
\begin{document}

\message{ !name(p1_2.tex) !offset(-3) }
...
\subsubsubsection{Equibiaxial deformation}
...
\message{ !name(p1_2.tex) !offset(-466) }
