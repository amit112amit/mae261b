function [W,f,K] = T3LinEle(X,x,quadOrder,lambda,mu)
% T3LINELE takes as input X_{ia} and x_{ia}, the reference and spatial
% positions for each node of a triangular 3-node linear element and
